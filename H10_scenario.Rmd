...
REco.params$model[, BioAcc  := c(2.28,0.83,0.93,0.43,rep(NA, 6),NA)]

# Unassimilated consumption
REco.params$model[, Unassim := c(rep(0.2, 6), rep(0.4, 2), rep(NA, 2),NA)]

#Detrital Fate
REco.params$model[, Detritus := c(rep(1, 9), rep(0, 1),0)]
REco.params$model[, Discards := c(rep(0,10),1)]
# 
# #Fisheries
# #Landings
